...
@section('section')
    <section class="w-2/3 mx-auto mt-20">
        <form action="{{route('credit.store')}}" method="post" id="creditForm">
            @csrf
            {{-- @method('get') --}}
            <table class=" w-full table-bordered text-white" style="font-family:Gothic A1; font-size:20px; background-color:#263343;">
                ...
                <tr>
                    <th class="w-1/4 p-2 text-center">충전계좌정보</th>
                    <th class="w-3/4 pl-3 text-left">
                        <button type="button" class="btn btn-secondary btn-sm">계좌요청</button>
                    </th>
                </tr>
                <tr>
                    <th class="w-1/4 p-2 text-center">충전금액</th>
                    <th class="w-3/4 pl-3 text-left">
                        <input type="text"  min="10000" max="5000000" value="0" name="inputMoney" id="inputMoney" size="12" class="text-black px-1"> 원 
                        ...
                        <button type="button" data-money="5000000" class="btn btn-secondary btn-money btn-sm">5,000,000</button>
            ...
            <p class="mt-10 flex justify-center" style="font-family:Gothic A1;">
                <span onclick="checkInputMoney()" class="btn px-4 py-1 bg-white text-2xl text-black  rounded">충전신청</span>
    ...
    <script>
        $('.btn-money').click(function (e) {
            ...
            money = (money > 5000000) ? 5000000 : money;
